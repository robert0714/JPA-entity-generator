...
public class SourceParserTest {
  ...
  public void initParser() {
    this.velocityEngine.setProperty(RuntimeConstants.RUNTIME_LOG_INSTANCE, NOPLogger.NOP_LOGGER);
    String encoding = StandardCharsets.UTF_8.name();
    this.velocityEngine.addProperty("input.encoding", encoding);
    this.velocityEngine.addProperty("output.encoding", encoding);
    this.sourceParser.setVelocityEngine(this.velocityEngine, encoding);
  }
  ...
  public void entitySourceTest() throws IOException {
	  this.sourceParser = new EntitySourceParserV2();
    initParser();
  ...
  public void controllerSourceTest() throws IOException {
	  this.sourceParser = new ControllerSourceParser();
    initParser();
  ...
  public void xmlSourceFileMerger() {
    new XmlSourceFileMerger().tryMerge(createGeneratorConfig(), createTable() );
  }
    ...
    config.setDriverConfig(
        ...
        .setTablesConfig(
            new TablesConfig()
                ...
                .setEntityPackageName("com.company.project.ocapi.entity")
  ...
  private String parse(String templateId) throws IOException {
    ...
    com.ifengxue.plugin.entity.Table table = createTable();
    String template =  loadTemplate(templateId+".vm") ; 
